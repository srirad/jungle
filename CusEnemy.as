package jungle {
	 ...
	 */	
	public class CusEnemy extends Box2DPhysicsObject
	{
		...
		public function CusEnemy(name:String, params:Object=null)
		{
		...
		/*	if (collider is _enemyClass && collider.body.GetLinearVelocity().y > enemyKillVelocity)
			...
			if (contact.GetManifold().m_localPoint) {
				...
				if ((collider is Platform && collisionAngle != 90) || collider is CusEnemy)
					turnAround();
			} */
