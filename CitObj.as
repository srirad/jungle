...
package jungle {
	 ...
	 * 
	 */
	public class CitObj extends CitrusSprite
	{		
		/** State of the hero. */
		public var state:int;
		
		public function CitObj(name:String, params:Object=null)
		{
			super(name, params);
		...
		{
			return _view ? view.texture.width : 0.5;
		}

		override public function get height():Number
		{
			return _view ? view.texture.height : 0.5;
		}
	}
}