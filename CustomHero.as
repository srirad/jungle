package jungle
{
	...
	public class CustomHero extends Box2DPhysicsObject
	{
		...
		protected var jumpVal:Boolean = true;
		...
		public function CustomHero(name:String, params:Object = null)
		{
			...
			//	stage.addEventListener(TouchEvent.TOUCH, handleClick);
		}
		
		/*	private function handleClick(e:TouchEvent):void
		   {
		   if (e.touches.pop().phase == TouchPhase.BEGAN)
		   {
		   trace("Touch event activated")
		   }
		 } */
		...
		override public function update(timeDelta:Number):void
		{
			...
			if (controlsEnabled)
			{
				...
				if (_onGround && jumpVal && !_ducking) // _ce.input.justDid("jump", inputChannel)
				{
