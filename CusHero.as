package jungle 
{
	 ...
	 * @author srini
	 */
	public class CusHero extends Box2DPhysicsObject
	{
		 
	public function CustomHero() 
		{
		 ...
		 */		
		 var onGiveDamage:Signal;
		
		/**
		 * Dispatched whenever the hero takes damage from an enemy. 
		 */		
		 var onTakeDamage:Signal;
		
		/**
		 * Dispatched whenever the hero's animation changes. 
		 */		
		 var onAnimationChange:Signal;

		 var _groundContacts:Array = [];//Used to determine if he's on ground or not.
		 var _enemyClass:Class = Enemy;
		 var _onGround:Boolean = false;
		 var _springOffEnemy:Number = -1;
		 var _hurtTimeoutID:uint;
		 var _hurt:Boolean = false;
		 var _friction:Number = 0.75;
		 var _playerMovingHero:Boolean = false;
		 var _controlsEnabled:Boolean = true;
		 var _ducking:Boolean = false;
		 var _combinedGroundAngle:Number = 0;
			
		/**
		 * Creates a new hero object.
		 */		
		 function Hero(name:String, params:Object = null)
		{
		 ...
		 */	
		 function get controlsEnabled():Boolean
		{
			return _controlsEnabled;
		}
		
		 function set controlsEnabled(value:Boolean):void
		{
		...
		[Inspectable(defaultValue="citrus.objects.platformer.box2d.Enemy",type="String")]
		 function set enemyClass(value:*):void
		{
			if (value is String)
		...
		override  function update(timeDelta:Number):void
		{
		 ...
		 */
		 function getWalkingSpeed():Number
		{
		...
		override  function handlePreSolve(contact:b2Contact, oldManifold:b2Manifold):void {
		...
		override  function handleBeginContact(contact:b2Contact):void {
		...
		override  function handleEndContact(contact:b2Contact):void {
		 ...
		 function getSlopeBasedMoveAngle():b2Vec2
		{
