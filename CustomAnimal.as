package jungle
{
	 ...
	 */
	public class CustomAnimal extends Box2DPhysicsObject
	{
		/**
		...
		public function CustomAnimal(name:String, params:Object = null)
		{
			...
			mc = new MovieClip(GetAssets.getAtlas().getTextures("goatsprite_"), 10);
