package jungle
{
	...
	public class BoxEx extends Sprite
	{
...
// show each quad (acting as a skin of each body)
	...
	//		m_world.ClearForces();
			...
			for (var bb:b2Body = m_world.GetBodyList(); bb; bb = bb.GetNext())
			{
				...
				trace("Enters first loop");
// key line here, we test if we find any starling.display.DisplayObject objects and apply the physics to them
				if (bb.GetUserData() is DisplayObject)
				{
					trace("Enters second loop");
